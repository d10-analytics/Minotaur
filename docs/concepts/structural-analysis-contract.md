...
| AC-03 | Deferred module bodies use final module state; nested deferred functions, lambdas, and methods use final enclosing-function state. Defaults and parameters retain immediate or lexical behavior, and callable-local imports do not mutate siblings. | `test_module_default_before_import_and_deferred_body_use_final_state`, `test_nested_callables_use_final_enclosing_function_import_state`, `test_module_lambda_body_uses_final_state_with_immediate_defaults_and_parameters`, and `test_nested_callable_import_does_not_mutate_enclosing_or_sibling_routes` |
